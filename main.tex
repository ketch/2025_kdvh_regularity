...
Next, we will verify these conditions for the viscous Burgers system \eqref{vbh}.
Please note that the condition \eqref{eq:dissipative_semidefinite}
of a dissipative semidefinite source is very strong. Indeed, it is
not satisfied for any of the hyperbolizations for higher-order PDEs
such as KdV-Burgers \cite[Section~3.1.2]{giesselmann2025convergence}
