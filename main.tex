...
{\color{red} 
\begin{remark}[Scaling, and zero] Could we write that 
$$
U =    \bar U_0 +    \overbrace{ U - \bar U_0}^{\tilde U }
$$
with $\bar U_0$ some constant value depending on the initial data (e.g. the average) so that any scaling   apply properly to both
$\bar U_0$ and $\tilde U$, and work with $\tilde U$ as main variable ?
\end{remark}
}
